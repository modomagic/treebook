...
class ContactUsControllerTest < ActionController::TestCase
  ...
  test "should create contact_u" do
    assert_difference('ContactU.count') do
      post :create, contact_u: { address: @contact_u.address, comment: @contact_u.comment, email: @contact_u.email, name: @contact_u.name, number: @contact_u.number }
    end
  ...
  test "should update contact_u" do
    put :update, id: @contact_u, contact_u: { address: @contact_u.address, comment: @contact_u.comment, email: @contact_u.email, name: @contact_u.name, number: @contact_u.number }
    assert_redirected_to contact_u_path(assigns(:contact_u))
  end
